// shell.js - inject shared sidebar and topbar
(function () {
  const navItems = [
    { id: 'home', icon: 'home', label: '首页', href: 'index.html' },
    { id: 'course', icon: 'book', label: '课程', href: 'overview.html' },
    { id: 'text', icon: 'file', label: '文本解析', href: 'text.html' },
    { id: 'emotion', icon: 'activity', label: '情感曲线', href: 'emotion.html' },
    { id: 'writing', icon: 'edit', label: '仿写训练', href: 'writing.html' },
    { id: 'chat', icon: 'chat', label: 'AI对话', href: 'chat.html' },
  ];
  ...
  function getActiveId() {
    ...
    if (path === 'overview.html') return 'course';
    if (path === 'course-content.html') return 'course';
